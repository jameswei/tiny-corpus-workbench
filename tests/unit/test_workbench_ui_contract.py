...
api.state.inspector="evidence";api.renderSelected();outputs.corpusEvidence=[treeText(e.inspectorPanel).includes("Coverage"),treeText(e.inspectorPanel).includes("Docling"),treeText(e.inspectorPanel).includes("D009 · policy")];
...
'''
        ...
        self.assertEqual(values["corpusEvidence"], [True, True, True])
